//===------- interface.h - HSAIL OpenMP interface definitions ---- HSA -*-===//
//
...
////////////////////////////////////////////////////////////////////////////////
// OMPTARGET_HSAIL private (debug / temportary?) interface
////////////////////////////////////////////////////////////////////////////////
...
// parallel
EXTERN void __kmpc_push_num_threads(__private kmp_Indent *loc, int32_t global_tid, int32_t num_threads);
//EXTERN void __kmpc_fork_call(__private kmp_Indent *loc, int32_t argc, kmp_ParFctPtr microtask, ...);
EXTERN void __kmpc_serialized_parallel(__private kmp_Indent *loc, uint32_t global_tid);
EXTERN void __kmpc_end_serialized_parallel(__private kmp_Indent *loc, uint32_t global_tid);
...
#endif
EXTERN void __kmpc_for_static_fini(__private kmp_Indent *loc, int32_t global_tid);
...
// reduction
EXTERN  int32_t __kmpc_reduce(
    __private kmp_Indent *loc,
    int32_t global_tid,
    int32_t varNum,
    size_t reduceSize,
    __private void *reduceData,
    __private kmp_ReductFctPtr *reductFct,
    __local kmp_CriticalName *lock);

EXTERN void __kmpc_end_reduce(
    __private kmp_Indent *loc,
    int32_t global_tid,
    __local kmp_CriticalName *lock);

EXTERN  int32_t __kmpc_reduce_nowait(
    __private kmp_Indent *loc,
    int32_t global_tid,
    int32_t varNum,
    size_t reduceSize,
...
EXTERN void __kmpc_end_reduce_nowait(
    __private kmp_Indent *loc,
    int32_t global_tid,
    __local kmp_CriticalName *lock);
...
EXTERN void __kmpc_atomic_fixed4_add (
    __private kmp_Indent * loc,
    int gtid,
    __global int32_t * addr,
    int32_t val) ;
